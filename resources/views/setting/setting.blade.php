          ...
          <div class="card-body">
            <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
              ...
              <li class="nav-item">
               ...
               {{-- about app --}}
              <li class="nav-item">
                <a class="nav-link" id="custom-content-below-profile-tab" data-toggle="pill" href="#custom-content-below-about" role="tab" aria-controls="custom-content-below-profile" aria-selected="false"> الحقوق والواجبات </a>
              </li>
				              	...
				              	<div class="card-body">
									<form action="{{route('updatemainsetting')}}" method="post">
										...
										<div class="form-group row">
											...
											<div class="col-lg-8">
							                    <input type="number" name="dilivary" class="form-control" step="any" value="{{$setting->dilivary}}" required>
											</div>
										</div>
              ...
              <div class="tab-pane fade" id="custom-content-below-about" role="tabpanel" aria-labelledby="custom-content-below-profile-tab">
  					<div class="panel-body">
							...
							<div class="card card-primary card-outline" style="margin-top: 10px">
								<div class="card-header">
				                	<h5 class="m-0">الحقوق والواجبات </h5>
				              	</div>
				              	<div class="card-body">
									<form action="{{route('updateaboutapp')}}" method="post">
										...
										<div class="row">
											...
											<div class="col-sm-6">
												<div class="form-group">
								                    <label for="exampleInputCopyrightAr"> الحقوق والواجبات  عربي</label>
											...
											<div class="col-sm-6">
												<div class="form-group">
								                    <label for="exampleInputCopyrightEn">الحقوق والواجبات   انجليزي</label>
							...
							<div class="card-body">
							  <form action="{{route('updatewhyus')}}" method="post">
								  ...
								  <div class="row">
									  ...
									  <div class="col-sm-6">
										  <div class="form-group">
											  <label for="exampleInputCopyrightAr">لماذا نحن بالعربية</label>
											  <textarea class="form-control " rows="8" name="why_us_ar" id="editor1" required="">{{$setting->why_us_ar}}</textarea>
										  </div>
									  </div>

									  <div class="col-sm-6">
										  <div class="form-group">
											  <label for="exampleInputCopyrightEn">لماذا نحن بالإنجليزية</label>
											  <textarea class="form-control " rows="8" name="why_us_en" id="editor1" required="">{{$setting->why_us_en}}</textarea>
										  </div>
									  </div>
...
var option = {
    ...
    CKEDITOR.replace( 'why_us_ar',option );
    CKEDITOR.replace( 'why_us_en',option );
    // add 
